 ...
 * 
 * Author      : Yang Dong
 * Created Time: 2020.08.04 18:41:30
 * 
...
int isLessOrEqual(int x, int y) {
    int sub = y + (~x + 1); // y - x
    int xs = x>>31&1, ys = y>>31&1, ss = sub>>31&1; // last digit
    return ((xs ^ ys) & xs) | !((xs ^ ys) | ss); // Sign differ OR sub >= 0
}
//4
/* 
